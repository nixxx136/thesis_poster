...
%    \node [cloud, right of=init] (system) {system};
    \node [block, text width=10em, below of = init] (initpop) {generate initial population};
    \node [block, below of=initpop] (calcfitness) {calculate fitness of each individual };
