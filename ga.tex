	...
	\begin{multicols}{2}
	Our GA has all the genetic algorithm functionalities, however, different variants should be use for different problems. Everyone is welcom to pull our code from Github and make changes for their uses. 
	...
	% \draw[step=1.5cm,gray,thin] (0,-3) grid (3,0);
